...
| **H-19** | **El buscador global mide 36 px de alto** (`h-9`) — por debajo del mínimo táctil del propio sistema — y la píldora «Volver a lo mío» 36 px | oficina táctil | todos | Objetivos táctiles | En una tablet de oficina, la «otra mitad de la navegación» es difícil de tocar | **2** | diaria |
...
| **E1 · Primitivos** | H-08, H-16, H-23: `BotonIcono`, `Pestanas`, `TarjetaOpcion`, `Casilla`; podar Button (`pendiente`, `success`); alturas por modo declaradas una vez; `/estilo` al día | ui/*, patrones/index, Estilo.jsx + los 16 sitios de solo-ícono | Bajo-medio | 8–10 |
